      ...
      <aside className="w-64 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/50 flex flex-col justify-between hidden md:flex">
        <div className="px-6 py-8">
          ...
          <nav className="mt-10 flex flex-col gap-2">
            ...
            <Link href="/softzeniq/services" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-900/50 hover:text-slate-900 dark:hover:text-slate-200 transition-colors">
              <FolderKanban className="h-5 w-5" />
              Services
            </Link>
